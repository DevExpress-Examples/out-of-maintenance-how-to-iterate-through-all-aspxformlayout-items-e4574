...
<%@ Register Assembly="DevExpress.Web.v13.1, Version=13.1.11.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web.ASPxFormLayout" TagPrefix="dx" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>How to iterate through all ASPxFormLayout items</title>
</head>
<body>
    <form id="form1" runat="server">
        <div>
            <dx:ASPxFormLayout ID="layout" runat="server">
                <Items>
                    <dx:TabbedLayoutGroup Caption="tabbed group">
                        <Items>
                                     ...
                                     <dx:LayoutItem Caption="LayoutItem2">
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer1" runat="server">
                                                <dx:ASPxDateEdit ID="de" runat="server" Width="170px"></dx:ASPxDateEdit>
            ...
            <dx:ASPxButton ID="ASPxButton1" runat="server" Text="Set Value To All" OnClick="ASPxButton1_Click" Width="116px"></dx:ASPxButton>
        </div>
    </form>
</body>
</html>